...
export function loadNavbar() {
    ...
    // 1. Render Structure
    nav.innerHTML = `
        <nav class="w-full bg-black/95 backdrop-blur-md fixed top-0 z-50 border-b border-gray-800 shadow-md h-[60px] md:h-[80px] flex items-center">
            ...
            <div id="search-overlay" class="hidden fixed top-0 left-0 w-full h-[60px] md:h-[80px] bg-black z-[100] flex items-center px-4 border-b border-gray-800 shadow-2xl transition-all duration-200">
            ...
            <div id="mobile-menu" class="hidden bg-[#111] border-b border-gray-800 absolute w-full left-0 top-[60px] md:top-[80px] shadow-xl z-40 h-screen">
